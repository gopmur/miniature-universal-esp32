...
enum class RsspAddress : uint8_t {
  ...
  LED_SERVICE_MAX_STACK_USAGE,
  IMU_SERVICE_MAX_STACK_USAGE,
  ESP_UART_TX_SERVICE_MAX_STACK_USAGE,
  ESP_UART_RX_SERVICE_MAX_STACK_USAGE,
  MOTOR_SERVICE_MAX_STACK_USAGE,
  CAN_RECV_SERVICE_MAX_STACK_USAGE,
  SD_SERVICE_MAX_STACK_USAGE,
  MONITOR_SERVICE_MAX_STACK_USAGE,
