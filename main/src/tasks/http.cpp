...
failed ");
    ...
    esp_err_t
    HttpServer::options_handler(httpd_req_t* req) {
  set_header(req);
...
esp_err_t HttpServer::register_dynamic_endpoints() {
  ...
  // HttpServer::check_for_update_handler);
  this->register_http_uri("/api/restart", HTTP_GET, HttpServer::restart_handler);
  this->register_http_uri("/api/states", HTTP_GET, HttpServer::get_state_handler);
  this->register_http_uri("/api/wifi/scan", HTTP_GET, HttpServer::scan_wifi_handler);
  this->register_http_uri("/api/wifi", HTTP_GET, HttpServer::get_connected_wifi);
  this->register_http_uri("/api/wifi/connect", HTTP_POST, HttpServer::connect_to_wifi_handler);
  this->register_http_uri("/api/wifi/disconnect", HTTP_GET, HttpServer::disconnect_wifi_handler);
  this->register_http_uri("/api/motors/zero_pos", HTTP_GET, HttpServer::motor_zero_pos);
  this->register_http_uri("/api/log/stop", HTTP_GET, HttpServer::stop_log);
  this->register_http_uri("/api/log/start", HTTP_GET, HttpServer::start_log);
