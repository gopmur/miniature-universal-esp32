  ...
  while (true) {
    ...
    while (true) {
      ...
      if (packet->header.b.type == LapplType::EOC) {
        self->queue.flush();
        json.set_number("esp32DnsServiceCpuUsage",
                        monitoring_data.dns_service_cpu_usage);
        json.set_number("esp32LedServiceCpuUsage",
                        monitoring_data.led_service_cpu_usage);
        json.set_number("esp32MonitorServiceCpuUsage",
                        monitoring_data.monitor_service_cpu_usage);
        json.set_number("esp32StmUartRxServiceCpuUsage",
                        monitoring_data.stm_uart_rx_service_cpu_usage);
        json.set_number("esp32WsServiceCpuUsage",
      ...
      switch (packet->address) {
        case LapplAddress::IMU_GX:
          json.set_number("imuGx", packet->get_float());
          break;
        case LapplAddress::IMU_GY:
          json.set_number("imuGy", packet->get_float());
          break;
        case LapplAddress::IMU_GZ:
          json.set_number("imuGz", packet->get_float());
          break;
        case LapplAddress::LED_SERVICE_CPU_USAGE:
          json.set_number("ledServiceCpuUsage", packet->get_float());
          break;
        case LapplAddress::IMU_SERVICE_CPU_USAGE:
          json.set_number("imuServiceCpuUsage", packet->get_float());
          break;
        case LapplAddress::MOTOR_SERVICE_CPU_USAGE:
          json.set_number("motorServiceCpuUsage", packet->get_float());
          break;
        case LapplAddress::SD_SERVICE_CPU_USAGE:
          json.set_number("sdServiceCpuUsage", packet->get_float());
          break;
        case LapplAddress::CAN_RECV_SERVICE_CPU_USAGE:
          json.set_number("canRecvServiceCpuUsage", packet->get_float());
          break;
        case LapplAddress::ESP_UART_RX_SERVICE_CPU_USAGE:
          json.set_number("uartEspRxServiceCpuUsage", packet->get_float());
          break;
        case LapplAddress::ESP_UART_TX_SERVICE_CPU_USAGE:
          json.set_number("uartEspTxServiceCpuUsage", packet->get_float());
          break;
        case LapplAddress::MONITOR_SERVICE_CPU_USAGE:
          json.set_number("monitorServiceCpuUsage", packet->get_float());
          break;
        default:
          break;
      }
